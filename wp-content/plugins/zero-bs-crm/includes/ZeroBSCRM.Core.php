...
final class ZeroBSCRM {
	...
	*/
	...
	private function init_hooks() {
		...
		// post-loaded migrations
		add_action( 'wp_loaded', array( $this, 'run_migrations_post_wp_loaded') );
	...
	*/
	...
	/**
	 * Runs post-page-load migrations
	 */
	public function run_migrations_post_wp_loaded(){
