...
function zeroBSCRM_html_addEditSegment($potentialID = -1)
{
    ...
    ?><div class="zbs-semantic wrap" id="zbs-segment-editor">
            ...
            <div class="ui large centralsimple segment">
                ...
                <div class="jog-on">
                    <button class="ui submit teal large icon button" id="zbs-segment-edit-act-p2preview"><?php esc_html_e('Preview Segment', "zero-bs-crm"); ?> <i class="unhide icon"></i></button>
