				...
				if ( !jpcrm_file_check_mime_extension( $_FILES['zbsc_file_attachment'] ) ){
					...
					if ( !$contact_dir_info ) {
						...
						if ( ! $upload_folder_exists ) {
							echo "<div class='ui message red' style='margin-right:20px'><i class='icon info'></i> " . esc_html( __( 'Error: Unable to create the file upload directory.', 'zero-bs-crm' ) ) . "</div>";
							$error_while_adding = true;
						} else {
							$zbs->load_encryption();
							...
							if ( 
								...
								$new_upload['type']          = $_FILES['zbsc_file_attachment']['type'];
								$new_upload['error']         = '';
								...
								echo "<div class='ui message red' style='margin-right:20px'><i class='icon info'></i> " . esc_html( __( 'Error: unable to upload the file.', 'zero-bs-crm' ) ) . "</div>";
								$error_while_adding = true;
							}
						}
					}
