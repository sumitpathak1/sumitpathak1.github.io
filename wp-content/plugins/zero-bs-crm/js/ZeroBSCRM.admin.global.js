     ...
     if ( typeof jQuery('.jpcrm-date').daterangepicker == "function" ){
		...
		jQuery('.jpcrm-date, .zbs-date').each( function( ind, ele ){
			...
			// .jpcrm-empty-start, and .jpcrm-custom-field need some specific options and to pass a function (legacy)
	     	if ( jQuery(ele).filter('.jpcrm-empty-start, .zbs-empty-start, .jpcrm-custom-field, .zbs-custom-field').length ){
		...
		jQuery('.jpcrm-date.jpcrm-empty-start, .jpcrm-date.jpcrm-custom-field, .zbs-date.zbs-empty-start, .zbs-date.zbs-custom-field').on('apply.daterangepicker', function ( event, picker ) {
...
function jpcrm_js_bind_datetimerangepicker( options, callback ){
     ...
     if ( typeof jQuery('.jpcrm-date').daterangepicker == "function" ){
     	...
     	// force time format
		if ( dateRangePickerOpts.locale.format && dateRangePickerOpts.locale.format.indexOf( 'hh:mm' ) == -1 ){
...
function jpcrm_js_bind_datetimepicker( options, callback ){
     ...
     if ( typeof jQuery('.jpcrm-date').daterangepicker == "function" ){
		...
		jQuery('.jpcrm-date-time, .zbs-date-time').not('.jpcrm-date-time-future').not('.zbs-date-time-future').each( function( ind, ele ){
...
function jpcrm_js_bind_datetimepicker_future( options, callback ){
     ...
     if ( typeof jQuery('.jpcrm-date').daterangepicker == "function" ){
		...
		jQuery('.jpcrm-date-time-future, .zbs-date-time-future').not('.zbs-date-time').not('.jpcrm-date-time').each( function( ind, ele ){
